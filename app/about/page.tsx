...
export default function About() {
  return (
    <div className="min-h-screen max-w-4xl w-full px-8 py-8">
      <div className="flex flex-row justify-between mb-2">
        <span className="text-sm">iliès chenene</span>
        <Navbar />
      </div>
      ...
      <section className="mt-10 text-sm leading-8">
        ...
        <p className="mb-6">
          ...
          i have a passion for machine learning, deep learning, and building things that work.
        </p>

        <p>
          i'm looking for an internship for my gap year —{" "}
          <a href="mailto:ilies.chenene@universite-paris-saclay.fr" className="font-bold hover:underline">
